<template>
  <button @click="blogStore.toggleTheme" class="fixed bottom-5 right-5 w-12 h-12 rounded-full flex items-center justify-center z-50 transition-colors" :style="{ backgroundColor: 'var(--switch-bg)', color: 'var(--text-color)' }">
